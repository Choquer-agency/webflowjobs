      ...
      (job) => `
        <tr>
          <td style="padding: 12px 16px; border-bottom: 1px solid #f0f0f0;">
            <a href="${SITE_URL}/jobs/${job.slug}" style="color: #180E39; text-decoration: none; font-weight: 600; font-size: 16px;">
              ${job.title}
            </a>
          ...
          <td style="padding: 12px 16px; border-bottom: 1px solid #f0f0f0; text-align: right;">
            <a href="${SITE_URL}/jobs/${job.slug}" style="color: #FF9500; text-decoration: none; font-size: 13px; font-weight: 600;">
              View Listing &rarr;
            </a>
          </td>
        </tr>`
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #ffffff;">
  <div style="max-width: 600px; margin: 0 auto; padding: 32px 20px;">
    ...
    <p style="margin: 0 0 24px;">
      <a href="${SITE_URL}" style="color: #FF9500; font-size: 20px; font-weight: 700; text-decoration: none; letter-spacing: -0.5px;">Webflow.Jobs</a>
    </p>

    <h1 style="margin: 0 0 16px; font-size: 22px; color: #180E39;">
    ...
    <!-- Job listings -->
    <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #f3f3f3; border-radius: 12px; overflow: hidden; margin-bottom: 24px;">
      <tr>
    ...
    <!-- Sponsorship CTA -->
    <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #FFF8F0 0%, #FFF2E0 100%); border: 1px solid #FFE0B2; border-radius: 12px; margin-bottom: 24px;">
      <tr>
        <td style="padding: 24px;">
          <h2 style="margin: 0 0 8px; font-size: 18px; color: #180E39;">
          ...
          <table cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
            <tr>
              <td style="padding-right: 16px;">
                <table cellpadding="0" cellspacing="0" style="border: 2px solid #FF9500; border-radius: 12px; overflow: hidden;">
                  <tr>
              ...
              <td>
                <table cellpadding="0" cellspacing="0" style="border: 1px solid #ddd; border-radius: 12px; overflow: hidden;">
                  <tr>
                    <td style="padding: 16px 20px; text-align: center;">
                      <div style="font-size: 24px; font-weight: 700; color: #180E39;">$75</div>
          ...
          <a href="${SITE_URL}/sponsor/${sponsorSlug}" style="display: inline-block; background-color: #FF9500; color: #fff; padding: 12px 28px; border-radius: 50px; text-decoration: none; font-weight: 600; font-size: 15px;">
    ...
    <!-- Footer -->
    <p style="color: #bbb; font-size: 11px; line-height: 1.5; margin: 32px 0 0;">
